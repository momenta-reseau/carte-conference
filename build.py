...
:root{{
  ...
  --t-affiche: clamp(1.875rem, 5.6vw, 2.625rem);  /* 30-42 px  ce qui doit rester */
  /* 🐛 Le plancher du nom valait 1.625rem, soit exactement `--t-titre`. Sur un
     téléphone, les deux clamps touchent leur plancher et le nom se retrouvait à
     la même taille qu'un intertitre : la hiérarchie tenait sur écran large et
     s'écrasait là où la page est le plus lue. Un clamp se vérifie aux DEUX bouts. */
  --t-nom: clamp(1.75rem, 4.6vw, 2.125rem);       /* 28-34 px  qui parle, un jalon */
